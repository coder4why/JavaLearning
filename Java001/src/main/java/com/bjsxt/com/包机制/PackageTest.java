...
public class PackageTest {
    ...
    public static void main(String[] args) {
        ...
        //不导入package的写法：
        com.bjsxt.com.内存分析.MallocAnalyse mallocs  = new com.bjsxt.com.内存分析.MallocAnalyse();
